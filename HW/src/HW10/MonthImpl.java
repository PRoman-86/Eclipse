...
public class MonthImpl implements IMonth {
	...
	@Override
	public Month[] utilMethod(String[] namesMonthArray) {
	...
	@Override
	public Month[] getQarter(Month[] monthArray) {
	...
	@Override
	public Month[] getHalfYear(Month[] monthArray) {
	...
	@Override
	public Month[] getYear(Month[] monthArray) {
